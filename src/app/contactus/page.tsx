              ...
              <Row>
                <Col className={`col-6`}>
                  <FormGroup>
                    ...
                    <Input id="name" name="name" placeholder={t("H_13")} type="text" autoComplete="none" maxLength={255} />
                  </FormGroup>
                </Col>
                <Col className={`col-6`}>
                  <FormGroup>
                    ...
                    <Input id="surname" name="surname" placeholder={t("H_13")} type="text" autoComplete="none" maxLength={255} />
                  </FormGroup>
                </Col>
                <Col className={`col-6`}>
                  <FormGroup>
                    ...
                    <Input id="phoneNo" name="phoneNo" placeholder={t("H_13")} autoComplete="none" type="text" maxLength={255} />
                  </FormGroup>
                </Col>
                <Col className={`col-6`}>
                  <FormGroup>
                    ...
                    <Input id="email" name="email" placeholder={t("H_13")} type="email" maxLength={255} />
                  </FormGroup>
                </Col>
                <Col className={`col-12`}>
                  <FormGroup>
                    ...
                    <Input id="examplePassword" name="password" placeholder={t("H_13")} type="textarea" maxLength={255} rows={5} />
                  </FormGroup>
                </Col>
              </Row>
